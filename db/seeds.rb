...
sugar = Song.create(song_name: "sugar", artist_name: "mareen morris", song_id: 7, artist_id: 7, song_length: "", genre: "country")
...
a1 = AddSongsToPlaylist.create(song_id: 1, playlist_id: 1)
a2 = AddSongsToPlaylist.create(song_id: 2, playlist_id: 1)
a3 = AddSongsToPlaylist.create(song_id: 3, playlist_id: 1)
a4 = AddSongsToPlaylist.create(song_id: 4, playlist_id: 1)
a5 = AddSongsToPlaylist.create(song_id: 5, playlist_id: 2)
a6 = AddSongsToPlaylist.create(song_id: 6, playlist_id: 2)
a7 = AddSongsToPlaylist.create(song_id: 7, playlist_id: 2)
a8 = AddSongsToPlaylist.create(song_id: 8, playlist_id: 2)
a9 = AddSongsToPlaylist.create(song_id: 9, playlist_id: 3)
a10 = AddSongsToPlaylist.create(song_id: 10, playlist_id: 3)
a11 = AddSongsToPlaylist.create(song_id: 11, playlist_id: 3)
a12 = AddSongsToPlaylist.create(song_id: 12, playlist_id: 3)
a13 = AddSongsToPlaylist.create(song_id: 13, playlist_id: 3)
a14 = AddSongsToPlaylist.create(song_id: 14, playlist_id: 4)
a15 = AddSongsToPlaylist.create(song_id: 15, playlist_id: 4)
a16 = AddSongsToPlaylist.create(song_id: 16, playlist_id: 4)
a17 = AddSongsToPlaylist.create(song_id: 17, playlist_id: 4)
a18 = AddSongsToPlaylist.create(song_id: 18, playlist_id: 5)
a19 = AddSongsToPlaylist.create(song_id: 19, playlist_id: 5)
a20 = AddSongsToPlaylist.create(song_id: 20, playlist_id: 5)
a21 = AddSongsToPlaylist.create(song_id: 21, playlist_id: 5)
a22 = AddSongsToPlaylist.create(song_id: 22, playlist_id: 5)
a23 = AddSongsToPlaylist.create(song_id: 23, playlist_id: 6)
a24 = AddSongsToPlaylist.create(song_id: 24, playlist_id: 6)
a25 = AddSongsToPlaylist.create(song_id: 25, playlist_id: 6)
a26 = AddSongsToPlaylist.create(song_id: 26, playlist_id: 6)
a27 = AddSongsToPlaylist.create(song_id: 27, playlist_id: 7)
a28 = AddSongsToPlaylist.create(song_id: 28, playlist_id: 7)
a29 = AddSongsToPlaylist.create(song_id: 29, playlist_id: 7)
a30 = AddSongsToPlaylist.create(song_id: 30, playlist_id: 7)
a31 = AddSongsToPlaylist.create(song_id: 31, playlist_id: 8)
a32 = AddSongsToPlaylist.create(song_id: 32, playlist_id: 8)
a33 = AddSongsToPlaylist.create(song_id: 33, playlist_id: 8)
a34 = AddSongsToPlaylist.create(song_id: 34, playlist_id: 8)
a35 = AddSongsToPlaylist.create(song_id: 35, playlist_id: 9)
a36 = AddSongsToPlaylist.create(song_id: 36, playlist_id: 9)
a37 = AddSongsToPlaylist.create(song_id: 37, playlist_id: 9)
a38 = AddSongsToPlaylist.create(song_id: 38, playlist_id: 9)
a39 = AddSongsToPlaylist.create(song_id: 39, playlist_id: 10)
a40 = AddSongsToPlaylist.create(song_id: 40, playlist_id: 10)
a41 = AddSongsToPlaylist.create(song_id: 41, playlist_id: 10)
a42 = AddSongsToPlaylist.create(song_id: 42, playlist_id: 10)
